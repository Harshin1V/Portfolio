  ...
  experience: [
    {
      ...
      summary: [
        ...
        "Modernized backend infrastructure with DevOps principles: Containerized backend services leveraging Docker and Terraform for Infrastructure as Code (IaC), and built high-performance streaming APIs with FastAPI and PostgreSQL, enabling seamless integration with Jira, Salesforce, and watsonx Orchestrate.",
